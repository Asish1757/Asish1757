...
void MoveForward(int *position, int direction)
{
    switch (direction)
    {
    case NORTH:
...
void MoveBackward(int *position, int direction)
{
    switch (direction)
    {
    case NORTH:
...
int main()
{
    ...
    while (1)
    {
        ...
        {
        case 'f':
            MoveForward(initialPosition, direction);
            break;
        case 'b':
            MoveBackward(initialPosition, direction);
            break;
        case 'l':
            turn_left(&direction);
            break;
